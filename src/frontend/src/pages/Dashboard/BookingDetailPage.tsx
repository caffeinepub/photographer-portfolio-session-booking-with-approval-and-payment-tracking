...
import { useGetBookingRequest, useAcceptBooking, useDenyBooking, useConfirmBooking, useSetBookingPrice, useUpdatePaymentStatus } from '../../hooks/useQueries';
...
export default function BookingDetailPage() {
  ...
  if (!booking) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <h1 className="font-serif text-3xl font-bold mb-4">Booking Not Found</h1>
  ...
  const statusConfig = statusVariants[booking.status] || { variant: 'outline', label: booking.status };
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Requested Date & Time</p>
              ...
              <div>
                ...
                <p className="font-medium">
                  {new Date(Number(booking.timestamp) / 1000000).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
                  })}
            ...
            {booking.proposedDateTime && (
              <>
                <Separator />
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Proposed/Confirmed Date & Time</p>
        ...
        {(booking.status === 'accepted' || booking.status === 'confirmed') && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage pricing and payment status</CardDescription>
            </CardHeader>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium text-lg">
                    {booking.price ? `$${(Number(booking.price) / 100).toFixed(2)}` : 'Not set'}
                  </p>
                </div>
                <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button onClick={handleSetPrice} disabled={setPriceMutation.isPending}>
                      {setPriceMutation.isPending ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Set'}
                    </Button>
                  </div>
                </div>
        ...
        {booking.status === 'pending' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Accept or deny this booking request</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="proposedDateTime">Proposed Date & Time (Optional)</Label>
                <Input
                  id="proposedDateTime"
              ...
              <div className="flex gap-3">
                <Button onClick={handleAccept} disabled={acceptBooking.isPending} className="flex-1">
                ...
                <Button onClick={handleDeny} disabled={denyBooking.isPending} variant="destructive" className="flex-1">
        ...
        {booking.status === 'accepted' && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set the final confirmed date and time</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="confirmedDateTime">Confirmed Date & Time *</Label>
                <Input
              ...
              <Button onClick={handleConfirm} disabled={confirmBooking.isPending} className="w-full">

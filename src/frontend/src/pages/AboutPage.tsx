        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-14">
              ...
              <h1 className="font-serif text-5xl md:text-6xl font-bold tracking-tight mb-0">
                About
              </h1>
            </div>

            {/* Profile + Bio */}
            <div className="grid md:grid-cols-[200px_1fr] gap-10 md:gap-14 items-start">
            ...
            <div className="border-t border-border mt-16 pt-12">
              <div className="grid sm:grid-cols-3 gap-8 text-center">
                <div>
                  <p className="font-serif text-3xl font-bold">Baseball</p>
                  <p className="text-sm text-muted-foreground mt-1">
                    Field Coverage
                  </p>
                </div>
                <div>
                  <p className="font-serif text-3xl font-bold">Basketball</p>
                  <p className="text-sm text-muted-foreground mt-1">
                    Court Action
                  </p>
                </div>
                <div>
                  <p className="font-serif text-3xl font-bold">Football</p>
                  <p className="text-sm text-muted-foreground mt-1">
                    Game Day Moments
                  </p>
                </div>
